          ...
          <form action="" class="form-group">
            ...
            <div class="row">
              <div class="form-group col-md-12">
                ...
                <input class="form-control" id="maintenance" type="number" min="0" v-model.number="maintenance" required>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12">
                <label for="work_days">Días laborales anuales:</label>
                <input class="form-control" id="work_days" type="number" min="0" v-model.number="work_days" required>
              </div>
            </div>
            <div class="row">
              <div class="form-group col-md-12">
            ...
            <div class="row">
              <div class="form-group col-md-12">
                ...
                <input class="form-control" id="pedidos" type="number" min="0" v-model.number="pedidos" required>
              </div>
            </div>     
            <div class="row">
              <div class="form-group col-md-12">
                <label for="service">Porcentaje de servicio:</label>
                <input class="form-control" id="service" type="number" min="0" v-model.number="service" required>
              </div>
            </div>                                            
            <div class="row justify-content-center">     
